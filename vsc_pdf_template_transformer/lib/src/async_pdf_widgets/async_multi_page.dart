...
class AsyncMultiPage extends AsyncPage {
  AsyncMultiPage({
    PageTheme? pageTheme,
    PdfPageFormat? pageFormat,
    required AsyncBuildListCallback build,
  ...
  final AsyncBuildListCallback _buildList;

  /// How the children should be placed along the cross axis.
  final CrossAxisAlignment crossAxisAlignment;

  /// A builder for the page header.
  final AsyncBuildCallback? header;

  /// A builder for the page footer.
  final AsyncBuildCallback? footer;
